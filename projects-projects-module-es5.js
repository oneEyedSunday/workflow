...
var ListComponent = /** @class */ (function () {
    function ListComponent(_proSvc) {
    ...
    ListComponent.prototype.getProcesses = function () {
        var _this = this;
        this._proSvc.fetchProcesses()
            .subscribe(function (processess) { return _this.processes = processess; }, function () { _this.loading = false; }, function () { return _this.loading = false; });
    };
...
var ViewComponent = /** @class */ (function () {
    function ViewComponent(_actRoute, _router, _dragulaService) {
    ...
    Object.defineProperty(ViewComponent.prototype, "boardContainerRef", {
        get: function () {
    ...
    ViewComponent.prototype.ngOnInit = function () {
        ...
        this._actRoute.data.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(function (data) {
            _this.existingProcess = !!!data.creating;
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["iif"])(function () { return _this.existingProcess; }, _this.getProcess(), _this.createBaseProcess());
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (process) {
            _this.bootstrapDragula();
            _this.process = process;
            feather_icons__WEBPACK_IMPORTED_MODULE_6__["replace"]();
            setTimeout(function () { return feather_icons__WEBPACK_IMPORTED_MODULE_6__["replace"](); });
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) { return _this.handleError(err); })).subscribe();
    };
    ViewComponent.prototype.ngAfterViewInit = function () {
        feather_icons__WEBPACK_IMPORTED_MODULE_6__["replace"]();
        setTimeout(function () { return feather_icons__WEBPACK_IMPORTED_MODULE_6__["replace"](); });
    };
    ViewComponent.prototype.getProcess = function () {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])({});
    };
    ViewComponent.prototype.createBaseProcess = function () {
    ...
    ViewComponent.prototype.bootstrapDragula = function () {
        // TODO (oneeyedsunday) close stage view when moving stages
    };
    ViewComponent.prototype.openSideBar = function (contentType, content) {
        this.sidePaneRef.nativeElement.classList.toggle('closed');
    };
    ViewComponent.prototype.confirmDeleteColumn = function (details) {
        // TODO modals
    };
    ViewComponent.prototype.preventDefault = function (event) {
...
var ProjectsModule = /** @class */ (function () {
    ...
    ProjectsModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](_components__WEBPACK_IMPORTED_MODULE_10__["components"], _containers__WEBPACK_IMPORTED_MODULE_9__["containers"], [
            ...
            providers: tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](_services__WEBPACK_IMPORTED_MODULE_11__["services"])
        })
    ], ProjectsModule);
...
var ProjectsService = /** @class */ (function () {
    function ProjectsService(http, httpErrorHandler) {
        this.http = http;
    ...
    ProjectsService.prototype.fetchProcesses = function () {
        return this.http.get(this.url + '/process').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (response) { return response; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.handleError('Fetch Projects', null)));
    };
    ProjectsService.prototype.getProcessById = function (id) {
        return this.http.get(this.url + '/process/' + id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (response) { return response; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.handleError('Fetch Project', null)));
    };
