(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~documents-documents-module~forms-forms-module~projects-projects-module"],{
...
let QuillEditorComponent = QuillEditorComponent_1 = class QuillEditorComponent {
    ...
    platformId, renderer, zone, config) {
        ...
        this.editorChangeHandler = (event, ...args) => {
            // only emit changes emitted by user interactions
...
//# sourceMappingURL=default~documents-documents-module~forms-forms-module~projects-projects-module-es2015.js.map