...
let CreateUpdateComponent = class CreateUpdateComponent {
    constructor(_actRoute, _router, _docSvc, cloudinary, zone) {
    ...
    ngOnInit() {
        ...
        this._actRoute.data.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])((data) => {
            ...
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["iif"])(() => this.editing, this.getDocument(), Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(new _shared_interfaces__WEBPACK_IMPORTED_MODULE_6__["Document"]()));
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(doc => this.document = doc), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(err => this.handleError(err))).subscribe();
    }
    getDocument() {
        return this._actRoute.paramMap.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])((params) => {
    ...
    onSubmit() {
        ...
        const data = this.responses[this.responses.length - 1];
    ...
    setUpCloudinaryUploader() {
        ...
        this.uploader.onProgressItem = (fileItem, progress) => upsertResponse({
            file: fileItem.file,
            progress,
            data: {}
        });
...
CreateUpdateComponent.ctorParameters = () => [
...
let ListComponent = class ListComponent {
    ...
    getDocuments() {
        this._docSvc.fetchDocuments()
            .subscribe(docs => this.documents = docs, () => { this.loading = false; }, () => this.loading = false);
    }
};
...
let DocumentService = class DocumentService {
    constructor(http, auth, httpErrorHandler) {
        this.http = http;
        this.auth = auth;
    ...
    fetchDocuments() {
        return this.http.get(this.url + '/process/document')
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(response => response), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.handleError('Fetch Documnets', null)));
    }
    getDocumentById(identifier) {
        return this.http.get(this.url + '/process/document/' + identifier).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(response => response), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.handleError('Fetch Document', null)));
    }
