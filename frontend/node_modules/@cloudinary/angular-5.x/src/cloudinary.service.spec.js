...
describe('Cloudinary service', function () {
    ...
    describe('transformKeyNames', function () {
        it('Transforms property names of json-like strings from kebab-case to snake_case', function () {
            expect(cloudinary_service_1.transformKeyNames('{"aaa-aaa":"1", "bbb-bbb":"2", "cc": "ccc-ccc"}')).toEqual({
                aaa_aaa: '1',
                bbb_bbb: '2',
                cc: 'ccc-ccc'
            });
        ...
        it('Transforms property names of json-like strings spanning multi-lines from kebab-case to snake_case', function () {
            expect(cloudinary_service_1.transformKeyNames("{\"aaa-aaa\":\"1\",\n            \"bbb-bbb\":\"2\",\n            \"cc\": \"ccc-ccc\"}")).toEqual({
                aaa_aaa: '1',
                bbb_bbb: '2',
                cc: 'ccc-ccc'
            });
        ...
        it('Transforms property names by stripping cld prefix', function () {
            // "cld" prefix can be followed by an optional dash or underscore
            expect(cloudinary_service_1.transformKeyNames('{"cldResponsive":"1", "cld-width":"2", "cld_height": "ccc-ccc"}')).toEqual({
                responsive: '1',
                width: '2',
                height: 'ccc-ccc'
            });
        ...
        it('does not affect primitive values', function () {
            expect(cloudinary_service_1.transformKeyNames(123)).toEqual(123);
            expect(cloudinary_service_1.transformKeyNames(undefined)).toBeUndefined();
            expect(cloudinary_service_1.transformKeyNames('')).toEqual('');
            expect(cloudinary_service_1.transformKeyNames('a b c')).toEqual('a b c');
        });
        it('iterates over array elements to transform its members', function () {
            expect(cloudinary_service_1.transformKeyNames([{
                    'aaa-aaa': 'aaa-aaa',
                    'bbb-bbb': 'bbb-bbb',
                    'ccc': 'ccc'
