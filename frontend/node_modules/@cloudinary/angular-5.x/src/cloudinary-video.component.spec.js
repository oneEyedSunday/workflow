...
describe('CloudinaryVideo', function () {
    ...
    describe('videos with nested transformations', function () {
        ...
        beforeEach(function () {
            ...
            des = fixture.debugElement.queryAll(platform_browser_1.By.directive(cloudinary_video_component_1.CloudinaryVideo));
        });
        it('creates a <video> element which encodes the directive attributes to the URL', function () {
            des.forEach(function (element, index) {
                var matchers = [
                ...
                var video = element.children[0].nativeElement;
                ...
                for (var i = 0; i < 3; i++) {
                    ...
                    expect(video.children[i].attributes.getNamedItem('src').value).toEqual(jasmine.stringMatching(matchers[index]));
    ...
    describe('Bound public-id', function () {
        var TestComponent = (function () {
            function TestComponent() {
                this.publicId = 'watchme';
            }
            TestComponent = __decorate([
                core_1.Component({
        ...
        it('creates a video element with a bound public-id', function () {
            ...
            // Created <video> element should have 3 child <source> elements for mp4, webm, ogg
            expect(video.childElementCount).toBe(3);
            var testMarkup = function (id) {
                for (var i = 0; i < 3; i++) {
                    expect(video.children[i].attributes.getNamedItem('src')).toBeDefined();
                    expect(video.children[i].attributes.getNamedItem('src').value).toEqual(jasmine.stringMatching(new RegExp("https://res.cloudinary.com/my_other_cloud/video/upload/g_north,l_text:arial_60:watchme,y_20/" + id)));
                }
            };
