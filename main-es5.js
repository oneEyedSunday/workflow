...
var routes = [
    ...
    },
    {
        ...
        children: [
            {
                path: 'projects',
                loadChildren: function () { return Promise.all(/*! import() | projects-projects-module */[__webpack_require__.e("default~documents-documents-module~forms-forms-module~projects-projects-module"), __webpack_require__.e("common"), __webpack_require__.e("projects-projects-module")]).then(__webpack_require__.bind(null, /*! ./projects/projects.module */ "./src/app/projects/projects.module.ts")).then(function (m) { return m.ProjectsModule; }); }
            },
            {
                path: 'forms',
            ...
            {
                path: 'organizations',
                loadChildren: function () { return Promise.all(/*! import() | organization-organization-module */[__webpack_require__.e("common"), __webpack_require__.e("organization-organization-module")]).then(__webpack_require__.bind(null, /*! ./organization/organization.module */ "./src/app/organization/organization.module.ts")).then(function (m) { return m.OrganizationModule; }); }
            }
        ]
    },
    { path: '**', redirectTo: '' }
...
var AuthInterceptor = /** @class */ (function () {
    ...
    AuthInterceptor.prototype.intercept = function (req, next) {
        var authToken = _auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"].getToken();
        if (authToken) {
...
var USER_DATA_TOKEN = 'workflow_user_data';
var TOKEN = 'workflow_token';
var AuthService = /** @class */ (function () {
    ...
    AuthService.getUserFromLocalStorage = function () {
    ...
    AuthService.prototype.login = function (creds) {
        ...
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_5__["AppConfig"].API_URL + "/account/login/", creds)
            ...
            _this._user.next(response.User);
...
var AuthGuard = /** @class */ (function () {
    ...
    AuthGuard.prototype.hasAuth = function () {
...
var HttpErrorHandler = /** @class */ (function () {
    function HttpErrorHandler(toastr) {
        var _this = this;
        this.toastr = toastr;
    ...
    HttpErrorHandler.prototype.handleError = function (serviceName, operation, result) {
        ...
        return function (e) {
            ...
            _this.toastr.error(message, operation);
...
var SanitizeStylePipe = /** @class */ (function () {
    ...
    SanitizeStylePipe.prototype.transform = function (value) {
...
var StatusBadgeComponent = /** @class */ (function () {
    function StatusBadgeComponent() {
    }
    StatusBadgeComponent.prototype.ngOnInit = function () {
